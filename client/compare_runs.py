...
def get_baseline_run(entity='paolodragol', project='aml_project/cicd-quickstart', tag='baseline'):
...
def compare_runs(entity='paolodragol',
                 project='aml_project/cicd-quickstart',
                 tag='baseline',
                 run_id=None):
